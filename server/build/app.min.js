...
/***/ "./server/src/file/colour_grid.js":
/*!****************************************!*\
  !*** ./server/src/file/colour_grid.js ***!
  \****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _colour_grid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./colour_grid */ \"./server/src/file/colour_grid.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"ColourGrid\", function() { return _colour_grid__WEBPACK_IMPORTED_MODULE_0__[\"ColourGrid\"]; });\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/file/index.js?");

/***/ }),

/***/ "./server/src/file/png.js":
/*!********************************!*\
  !*** ./server/src/file/png.js ***!
  \********************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Manager\", function() { return Manager; });\n/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared */ \"./shared/index.js\");\n/* harmony import */ var _file__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./file */ \"./server/src/file/index.js\");\n/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user */ \"./server/src/user.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ \"./server/src/utils/index.js\");\n\n\n\n\n\nclass Manager {\n  constructor(grid) {\n    this.token = new _utils__WEBPACK_IMPORTED_MODULE_3__[\"SessionToken\"]();\n    this.clients = {};\n    this.clientCount = 0;\n    this.packet = new _utils__WEBPACK_IMPORTED_MODULE_3__[\"PacketUtils\"](this.clients);\n    this.grid = new _file__WEBPACK_IMPORTED_MODULE_1__[\"ColourGrid\"](this);\n    this.initUserActions();\n  }\n\n  add(req) {\n    // add new client, ping client\n    const client = req.accept(null, req.origin);\n    const id = this.token.getUnique();\n    const onAction = (action, id, data) => {\n      this.onUserAction(action, id, data);\n    };\n    this.clients[id] = new _user__WEBPACK_IMPORTED_MODULE_2__[\"User\"](client, id, onAction);\n\n    // send client info\n    this.packet.initialise(id);\n    this.packet.map(id, this.grid.getImageSrc());\n    this.packet.sessionImageData(id, this.grid.getSessionImageData());\n\n    // log remoteAddress\n    this.clientCount += 1;\n    console.log(`User ${id.substr(0, 10)}... @ ${req.origin} ${req.remoteAddress} connected.`);\n  }\n\n  remove(id) {\n    delete this.clients[id];\n    this.token.unregister(id);\n    this.packet.broadcastRemovePlayer(id);\n    this.clientCount = Math.max(0, this.clientCount - 1);\n    console.log(`User ${id.substr(0, 10)}... disconnected.`);\n  }\n\n  initUserActions() {\n    this.on = {};\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].MOVE] = (id, data) => {\n      this.packet.broadcastPlayerStates(id);\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].PAINT] = (id, data) => {\n      if (this.grid.setPixel(data)) {\n        this.packet.broadcastPaint(this.grid.getChanged());\n        this.grid.flush();\n      }\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].MESSAGE] = (id, data) => {\n      this.packet.broadcastMessage(data.from, data.message);\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].PING] = (id, data) => {\n      this.packet.pong(id, data);\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].MUTE] = (id, data) => {\n      this.packet.notify(id, `Don't spam. Muted ${data} seconds.`);\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].SET_COLOUR] = (id, data) => {};\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].SET_NAME] = (id, data) => {\n      this.packet.notify(id, `Welcome ${data}!`);\n    };\n    this.on[_shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].CONNECTION_CLOSED] = (id, data) => {\n      this.remove(id);\n    };\n  }\n\n  onUserAction(action, id, data) {\n    // handle valid client actions\n    if (action != _shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].MOVE && action != _shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].PAINT && action != _shared__WEBPACK_IMPORTED_MODULE_0__[\"ACTION\"].PING) {\n      console.log(id.substr(0, 8), action, data);\n    }\n\n    if (this.on[action]) {\n      this.on[action](id, data);\n    }\n  }\n}\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/manager.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _rate_limiter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rate_limiter */ \"./server/src/utils/rate_limiter.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"RateLimiter\", function() { return _rate_limiter__WEBPACK_IMPORTED_MODULE_0__[\"RateLimiter\"]; });\n\n/* harmony import */ var _session_token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./session_token */ \"./server/src/utils/session_token.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"SessionToken\", function() { return _session_token__WEBPACK_IMPORTED_MODULE_1__[\"SessionToken\"]; });\n\n/* harmony import */ var _packet_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packet_utils */ \"./server/src/utils/packet_utils.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"PacketUtils\", function() { return _packet_utils__WEBPACK_IMPORTED_MODULE_2__[\"PacketUtils\"]; });\n\n/* harmony import */ var _converter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./converter */ \"./server/src/utils/converter.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Converter\", function() { return _converter__WEBPACK_IMPORTED_MODULE_3__[\"Converter\"]; });\n\n\n\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/utils/index.js?");

/***/ }),

/***/ "./server/src/utils/packet_utils.js":
/*!******************************************!*\
  !*** ./server/src/utils/packet_utils.js ***!
  \******************************************/
