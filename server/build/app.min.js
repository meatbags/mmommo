...
/*!*************************************!*\
  !*** ./server/src/modules/index.js ***!
  \*************************************/
/*! exports provided: UserManager, DatabaseHandler, ColourGrid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _users__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users */ \"./server/src/modules/users/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"UserManager\", function() { return _users__WEBPACK_IMPORTED_MODULE_0__[\"UserManager\"]; });\n\n/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./db */ \"./server/src/modules/db/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"ColourGrid\", function() { return _db__WEBPACK_IMPORTED_MODULE_1__[\"ColourGrid\"]; });\n\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/modules/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _user_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user_manager */ \"./server/src/modules/users/user_manager.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"UserManager\", function() { return _user_manager__WEBPACK_IMPORTED_MODULE_0__[\"UserManager\"]; });\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/modules/users/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"UserManager\", function() { return UserManager; });\n/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user */ \"./server/src/modules/users/user.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ \"./server/src/modules/utils/index.js\");\n/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared */ \"./shared/index.js\");\n\n\n\n\nclass UserManager {\n  constructor(grid) {\n    this.token = new _utils__WEBPACK_IMPORTED_MODULE_1__[\"SessionToken\"]();\n    this.clients = {};\n    this.packet = new _utils__WEBPACK_IMPORTED_MODULE_1__[\"PacketUtils\"](this.clients);\n    this.grid = grid;\n  }\n\n  add(client) {\n    // add new client, ping client\n    const id = this.token.getUnique();\n    const onAction = (action, id, data) => {\n      this.onUserAction(action, id, data);\n    };\n    this.clients[id] = new _user__WEBPACK_IMPORTED_MODULE_0__[\"User\"](client, id, onAction);\n\n    // send client info\n    this.packet.initialise(id);\n    this.packet.sessionImageData(id, this.grid.getSessionImageData());\n  }\n\n  onUserAction(action, id, data) {\n    // handle valid client actions\n    if (action != _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].MOVE && action != _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].PAINT && action != _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].PING) {\n      console.log(action, data);\n    }\n\n    switch (action) {\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].MOVE:\n        {\n          this.packet.broadcastPlayerStates(id);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].PAINT:\n        {\n          this.grid.setPixel(data);\n          const changed = this.grid.getChanged();\n          if (changed.length) {\n            this.packet.broadcastPaint(changed);\n            this.grid.flush();\n          }\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].MESSAGE:\n        {\n          this.packet.broadcastMessage(data.from, data.message);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].PING:\n        {\n          this.packet.pong(id, data);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].MUTE:\n        {\n          this.packet.notify(id, `Don't spam. Muted ${data} seconds.`);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].SET_NAME:\n        {\n          this.packet.notify(id, `Welcome ${data}!`);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_2__[\"ACTION\"].CONNECTION_CLOSED:\n        {\n          delete this.clients[id];\n          this.token.unregister(id);\n          this.packet.broadcastRemovePlayer(id);\n          console.log('Disconnected', id);\n          break;\n        }\n      default:\n        {\n          break;\n        }\n    }\n  }\n}\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/modules/users/user_manager.js?");
