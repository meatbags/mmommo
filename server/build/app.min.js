...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ClientManager\", function() { return ClientManager; });\n/* harmony import */ var _client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./client */ \"./server/src/modules/client.js\");\n/* harmony import */ var _session_token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./session_token */ \"./server/src/modules/session_token.js\");\n/* harmony import */ var _packet_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packet_utils */ \"./server/src/modules/packet_utils.js\");\n/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared */ \"./shared/index.js\");\n\n\n\n\n\nclass ClientManager {\n  constructor() {\n    this.token = new _session_token__WEBPACK_IMPORTED_MODULE_1__[\"SessionToken\"]();\n    this.clients = {};\n    this.packet = new _packet_utils__WEBPACK_IMPORTED_MODULE_2__[\"PacketUtils\"](this.clients);\n  }\n\n  add(client) {\n    if (this.validate(client)) {\n      const id = this.token.getUnique();\n      const onAction = (action, id, data) => {\n        this.onUserAction(action, id, data);\n      };\n      this.clients[id] = new _client__WEBPACK_IMPORTED_MODULE_0__[\"Client\"](client, id, onAction);\n      this.packet.ping(id, { rate: this.clients[id].getRate() });\n    }\n  }\n\n  onUserAction(action, id, data) {\n    console.log(action, data);\n\n    switch (action) {\n      case _shared__WEBPACK_IMPORTED_MODULE_3__[\"ACTION\"].MESSAGE:\n        {\n          this.packet.broadcastMessage(data.from, data.message);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_3__[\"ACTION\"].CONNECTION_CLOSED:\n        {\n          this.token.unregister(id);\n          console.log('User DC', id);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_3__[\"ACTION\"].MUTE:\n        {\n          this.packet.notify(id, `Don't spam. Muted ${data} seconds.`);\n          break;\n        }\n      case _shared__WEBPACK_IMPORTED_MODULE_3__[\"ACTION\"].SET_NAME:\n        {\n          this.clients[id].setName(data);\n          var name = this.clients[id].getName();\n          this.packet.notify(id, `Welcome ${name}!`);\n          break;\n        }\n      default:\n        {\n          break;\n        }\n    }\n  }\n\n  validate(client) {\n    return true;\n  }\n}\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/modules/client_manager.js?");
...
/*!*************************************!*\
  !*** ./server/src/modules/index.js ***!
  \*************************************/
/*! exports provided: Socket, ClientManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _socket__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./socket */ \"./server/src/modules/socket.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Socket\", function() { return _socket__WEBPACK_IMPORTED_MODULE_0__[\"Socket\"]; });\n\n/* harmony import */ var _client_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./client_manager */ \"./server/src/modules/client_manager.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"ClientManager\", function() { return _client_manager__WEBPACK_IMPORTED_MODULE_1__[\"ClientManager\"]; });\n\n\n\n\n//# sourceURL=webpack://mmommo/./server/src/modules/index.js?");

/***/ }),

/***/ "./server/src/modules/packet_utils.js":
/*!********************************************!*\
  !*** ./server/src/modules/packet_utils.js ***!
  \********************************************/
